...
/*!
     ...
     \param Device : Port name (/dev/ttyS0, /dev/ttyACM0, /dev/ttyUSB0 ... for
   linux) \param Bauds : Baud rate of the Serial port. \n Supported baud rate
   for Linux :\n
                        - 110
                        - 300
                        - 600
  ...
  */
char Serial::openDevice(int devNum, const unsigned int Bauds) {
  // Structure with the device's options
  struct termios options;
  char device[20];
  sprintf(device, "/dev/ttyAMA%d", devNum);
...
*/
void Serial::closeDevice() { close(fd); }
...
/*!
  ...
  */
char Serial::writeString(const char *receivedString) {
...
/*!
  ...
  */
int Serial::readStringNoTimeOut(char *receivedString, unsigned int maxNbBytes) {
...
/*!
  ...
  */
int Serial::readString(char *receivedString, unsigned int maxNbBytes,
...
/*!
  ...
  */
int Serial::readBytes(void *buffer, unsigned int maxNbBytes,
