 ...
 * @param time time
 */
void DataGen::getData(vector<byte> &data, double time) {
    //speed
 ...
 */
void DataGen::addDoubleToArray(vector<byte> &dataVec, double data) {
 ...
 */
template<typename E>
void DataGen::dataToByteArray(vector<byte> &dataVec, E data) {
