...
Popup {
    ...
    contentItem: Rectangle {
                ...
                GridLayout {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            property var err: ["", "Over Current", "Unused", "Hole Sensor Fault", "Motor Locked", "Sensor Fault 1", "Sensor Fault 2", "Unused",
        ...
        Text {
            ...
            font.pointSize: 32
            text: can_close ? qsTr("All faults cleared\nTap anywhere other than the top-right corner of the screen to clear this warning") : qsTr("")
            color: "#ffffff"
        }
    }
}
